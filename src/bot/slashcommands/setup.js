...
async function handlePresetSetup(interaction, recursionUUID) {
	...
	try {
				...
				components: [
					{
						...
						options: [
							...
							},
							{
								...
								value: 'channel',
								default:
									interaction.channel.id === guildEvents.channelCreate &&
									interaction.channel.id === guildEvents.channelUpdate &&
									interaction.channel.id === guildEvents.channelDelete,
							},
							{
								...
								value: 'message',
								default:
									interaction.channel.id === guildEvents.messageUpdate &&
									interaction.channel.id === guildEvents.messageDelete &&
									interaction.channel.id === guildEvents.messageDeleteBulk,
							},
							{
								...
								value: 'member',
								default:
									interaction.channel.id === guildEvents.guildMemberUpdate &&
									interaction.channel.id === guildEvents.guildMemberBoostUpdate &&
									interaction.channel.id === guildEvents.guildMemberNickUpdate,
							},
							{
								...
								value: 'moderation',
								default:
									interaction.channel.id === guildEvents.guildBanAdd &&
									interaction.channel.id === guildEvents.guildBanRemove &&
									interaction.channel.id === guildEvents.guildMemberKick,
							},
							{
								...
								value: 'joinlog',
								default:
									interaction.channel.id === guildEvents.guildMemberAdd &&
									interaction.channel.id === guildEvents.guildMemberRemove,
							},
							{
								label: 'Server Events',
							...
							},
							{
								...
								value: 'role',
								default:
									interaction.channel.id === guildEvents.guildRoleCreate &&
									interaction.channel.id === guildEvents.guildRoleDelete &&
									interaction.channel.id === guildEvents.guildRoleUpdate,
							},
							{
								label: 'Voice Events',
								...
								value: 'voice',
								default:
									interaction.channel.id === guildEvents.voiceChannelLeave &&
									interaction.channel.id === guildEvents.voiceChannelSwitch &&
									interaction.channel.id === guildEvents.voiceStateUpdate &&
									interaction.channel.id === guildEvents.voiceChannelJoin,
							},
						],
					},
				],
		...
		const setupEmbed = {
			...
			description:
				'Use the option selector below choose preset events for logging to **here**. If you want to learn more about the usage of this command, see `/help guide: Usage` and `/help`.',
			...
			embeds: [
				{
					...
					description: `I cannot update logging settings with new presets: I need the following permissions in this channel: ${missingPermissions
						.map((p) => `**${p}**`)
						.join(', ')}. Have questions? See \`/help usage: Guide\``,
...
async function handleIndividualSetup(interaction, recursionUUID) {
	...
	try {
				...
				components: [
					{
						...
						options: [
							...
							},
							{
								...
								value: 'channelCreate',
								default: guildEvents.channelCreate === interaction.channel.id,
							},
							{
								label: 'Channel Update',
								description: 'On channel settings change',
								value: 'channelUpdate',
								default: guildEvents.channelUpdate === interaction.channel.id,
							},
							{
								label: 'Channel Delete',
								description: 'On channel deletion',
								value: 'channelDelete',
								default: guildEvents.channelDelete === interaction.channel.id,
							},
							{
								label: 'Member Banned',
								description: 'On member being banned',
								value: 'guildBanAdd',
								default: guildEvents.guildBanAdd === interaction.channel.id,
							},
							{
								label: 'Member Unbanned',
								description: 'On member being unbanned',
								value: 'guildBanRemove',
								default: guildEvents.guildBanRemove === interaction.channel.id,
							},
							{
								label: 'Role Create',
								description: 'On role creation',
								value: 'guildRoleCreate',
								default: guildEvents.guildRoleCreate === interaction.channel.id,
							},
							{
								label: 'Role Delete',
								description: 'On role deletion',
								value: 'guildRoleDelete',
								default: guildEvents.guildRoleDelete === interaction.channel.id,
							},
							{
								label: 'Role Update',
								description: 'On role update',
								value: 'guildRoleUpdate',
								default: guildEvents.guildRoleUpdate === interaction.channel.id,
							},
							{
								label: 'Server Settings Change',
								description: 'On server settings being changed',

								value: 'guildUpdate',
								default: guildEvents.guildUpdate === interaction.channel.id,
							},
							{
								label: 'Server Emojis Change',
								description: 'On emojis being added or removed',
								value: 'guildEmojisUpdate',
								default: guildEvents.guildEmojisUpdate === interaction.channel.id,
							},
							{
								label: 'Message Delete',
								description: 'On a single message being deleted',

								value: 'messageDelete',
								default: guildEvents.messageDelete === interaction.channel.id,
							},
							{
								label: 'Bulk Message Delete',
								description: 'On a message purge or member ban',
								value: 'messageDeleteBulk',
								default: guildEvents.messageDeleteBulk === interaction.channel.id,
							},
							{
								label: 'Message Edit',
								description: 'On message update',
								value: 'messageUpdate',
								default: guildEvents.messageUpdate === interaction.channel.id,
							},
							{
								label: 'Member Join',
								description: 'On member joining the server',
								value: 'guildMemberAdd',
								default: guildEvents.guildMemberAdd === interaction.channel.id,
							},
							{
								label: 'Member Kick',
								description: 'On member being kicked',
								value: 'guildMemberKick',
								default: guildEvents.guildMemberKick === interaction.channel.id,
							},
							{
								label: 'Member Leave',
								description: 'On member leaving the server',
								value: 'guildMemberRemove',
								default: guildEvents.guildMemberRemove === interaction.channel.id,
							},
							{
								label: 'Member Nickname Update',
								description: 'On member updating their nickname (conditional log!)',
								value: 'guildMemberNickUpdate',
								default: guildEvents.guildMemberNickUpdate === interaction.channel.id,
							},
							{
								label: 'Member Role Add/Remove',
								description: 'On member getting or losing a role',
								value: 'guildMemberUpdate',
								default: guildEvents.guildMemberUpdate === interaction.channel.id,
							},
							{
								label: 'Member Gate Verify',
								description: 'On member accepting community rules',
								value: 'guildMemberVerify',
								default: guildEvents.guildMemberVerify === interaction.channel.id,
							},
							{
								label: 'Voice Channel Leave',
								description: 'On member leaving a voice channel',
								value: 'voiceChannelLeave',
								default: guildEvents.voiceChannelLeave === interaction.channel.id,
							},
							{
								label: 'Voice Channel Join',
								description: 'On member joining a voice channel',
								value: 'voiceChannelJoin',
								default: guildEvents.voiceChannelJoin === interaction.channel.id,
							},
							{
								label: 'Voice Channel Moved',
								description: 'On member getting moved from a voice channel',
								value: 'voiceChannelSwitch',
								default: guildEvents.voiceChannelSwitch === interaction.channel.id,
							},
							{
								label: 'Member Voice Muted/Deafened',
								description: 'On member being muted or deafened',
		...
		const setupEmbed = {
			title: 'Welcome to the Logger setup utility',
			description:
				'Use the option selector below choose individual events for logging to **here**. If you want to learn more about the usage of this command, see `/help guide: Usage` and `/help`.',
			color: EMBED_COLORS.PURPLED_BLUE,
			thumbnail: {
				url: interaction.member.user.dynamicAvatarURL(null, 64),
			},
